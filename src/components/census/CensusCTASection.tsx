...
export function CensusCTASection() {
  ...
  return (
    <section ref={ref} className="composition">
      <div className="max-w-3xl mx-auto px-6 sm:px-8 text-center">
        ...
        >
          Explore state-level indicators across population, health, literacy, and demographics, or read about our data sources and multi-vintage methodology.
        </motion.p>
