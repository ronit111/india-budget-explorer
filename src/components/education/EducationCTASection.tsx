  ...
  return (
    <section ref={ref} className="composition">
      <div className="max-w-3xl mx-auto px-6 sm:px-8 text-center">
        ...
        >
          Explore state-level indicators across enrollment, quality, infrastructure, and spending, or read about our data sources and methodology.
        </motion.p>
