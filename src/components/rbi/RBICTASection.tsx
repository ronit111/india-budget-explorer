  ...
  return (
    <section ref={ref} className="composition">
      <div className="max-w-3xl mx-auto px-6 sm:px-8 text-center">
        ...
        >
          Explore individual RBI indicators across monetary policy, liquidity, credit, and external sectors, or read about our data sources and methodology.
        </motion.p>
