...
export function StatesCTASection() {
  ...
  return (
    <section ref={ref} className="composition">
      <div className="max-w-3xl mx-auto px-6 sm:px-8 text-center">
        ...
        >
          Explore individual state indicators across GSDP, revenue, fiscal health, and per capita income, or read about our data sources and methodology.
        </motion.p>
