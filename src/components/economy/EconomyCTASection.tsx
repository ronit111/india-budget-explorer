...
export function EconomyCTASection() {
  ...
  return (
    <section ref={ref} className="composition">
      <div className="max-w-3xl mx-auto px-6 sm:px-8 text-center">
        ...
        >
          Explore individual indicators across a decade of data, or read about our data sources and methodology.
        </motion.p>
        ...
        >
          <Link
            ...
            style={{
              background: 'linear-gradient(135deg, var(--cyan), #7CF5E9)',
              color: '#06080f',
            }}
          >
            Explore indicators
