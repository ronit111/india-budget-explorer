  ...
  return (
    <section ref={ref} id="oop" className="composition" style={{ background: 'var(--bg-surface)' }}>
      <div className="max-w-7xl mx-auto px-6 sm:px-8">
        ...
        >
          For every Rs 100 spent on healthcare in India, over Rs 50 comes from the patient's own pocket. This is among the highest out-of-pocket rates in the world.
        </motion.p>
