...
export function HealthcareCTASection() {
  ...
  return (
    <section ref={ref} className="composition">
      <div className="max-w-3xl mx-auto px-6 sm:px-8 text-center">
        ...
        >
          Explore state-level indicators across infrastructure, spending, immunization, and disease burden, or read about our data sources and methodology.
        </motion.p>
