...
export function ElectionsCTASection() {
  ...
  return (
    <section ref={ref} className="composition">
      <div className="max-w-3xl mx-auto px-6 sm:px-8 text-center">
        ...
        >
          Explore state-level election data, or read about our sources and how we compiled 67 years of Lok Sabha results.
        </motion.p>
