...
export function EnvironmentCTASection() {
  ...
  return (
    <section ref={ref} className="composition">
      <div className="max-w-3xl mx-auto px-6 sm:px-8 text-center">
        ...
        >
          Explore state-level indicators across air quality, forests, energy, and water, or read about our data sources and methodology.
        </motion.p>
