  ...
  return (
    <section ref={ref} id="energy-transition" className="composition" style={{ background: 'var(--bg-surface)' }}>
      <div className="max-w-7xl mx-auto px-6 sm:px-8">
        ...
        >
          Solar capacity exploded from 3.7 GW to 82.8 GW in 9 years — a 22× increase. But coal hasn't shrunk. India is adding clean energy on top of fossil fuels, not replacing them.{' '}
