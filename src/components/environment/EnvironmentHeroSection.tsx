...
import type { EnvironmentSummary } from '../../lib/data/schema.ts';

interface EnvironmentHeroSectionProps {
  summary: EnvironmentSummary | null;
}

export function EnvironmentHeroSection({ summary }: EnvironmentHeroSectionProps) {
  const [ref, isVisible] = useScrollTrigger({ threshold: 0.2 });

  const pm25 = summary ? summary.pm25.toFixed(1) : '—';
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        ...
        >
          <div className="text-hero gradient-text-teal">
            {pm25}
          </div>
          <p
        ...
        <motion.p
          ...
          style={{ color: 'var(--text-secondary)' }}
        >
          Air, forests, energy, water — India's environmental balance sheet.
        </motion.p>
