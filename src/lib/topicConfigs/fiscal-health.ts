...
export const fiscalHealth: TopicDef = {
  ...
  sections: [
    ...
    // ── Section 2: Spending vs borrowing ──────────────────────────
    {
      ...
      annotation:
        'The fiscal deficit tells you how much the government borrows to fund its spending. India has been on a consolidation path — from 9.2% during COVID to a target of 4.4% in 2025-26 — but the absolute deficit is still ₹16.1 lakh crore.',
