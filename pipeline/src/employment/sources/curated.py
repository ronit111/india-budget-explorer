...
PLFS_STATE_DATA = [
    ...
    {"id": "tg", "name": "Telangana", "lfpr": 55.8, "lfprMale": 74.6, "lfprFemale": 36.6, "unemploymentRate": 3.8, "wpr": 53.7, "selfEmployed": 42.4},
    ...
    {"id": "ct", "name": "Chhattisgarh", "lfpr": 55.4, "lfprMale": 76.2, "lfprFemale": 34.6, "unemploymentRate": 2.6, "wpr": 54.0, "selfEmployed": 58.6},
...
NATIONAL_TOTALS = {
    ...
    "youthUnemployment": 12.8,      # PLFS annual 15-29 age group
    "femaleLfpr": 35.2,             # PLFS quarterly
    "workforceTotal": 57.0,         # crores (PLFS annual 2023-24)
    "selfEmployedPct": 52.4,        # PLFS annual 2023-24
}
